    ...
    <div class="container">
        <div class="content-holder home-work clearfix">
            <div class="row home-work__title">
                <?php $section_title = devwp_split_last_word_from_string( get_field( 'work_title' ) ) ?>
            ...
            <div class="row home-work__content">
                <p class="section-description"><?php esc_html( the_field( 'work_description' ) ); ?></p>
                <?php $work_link = get_field('work_link'); ?>
                <?php if ( $work_link ) : ?>
